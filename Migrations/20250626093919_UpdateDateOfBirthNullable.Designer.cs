...
namespace SWP391_ITMMS_Api.Migrations
{
    ...
    [Migration("20250626093919_UpdateDateOfBirthNullable")]
            ...
            modelBuilder.Entity("SWP391_ITMMS_Api.Models.TreatmentService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BasePrice = 85000000m,
                            CreatedAt = new DateTime(2025, 6, 26, 16, 39, 19, 294, DateTimeKind.Local).AddTicks(2892),
                        ...
                        new
                        {
                            Id = 2,
                            BasePrice = 15000000m,
                            CreatedAt = new DateTime(2025, 6, 26, 16, 39, 19, 294, DateTimeKind.Local).AddTicks(2898),
                        ...
                        new
                        {
                            Id = 3,
                            BasePrice = 95000000m,
                            CreatedAt = new DateTime(2025, 6, 26, 16, 39, 19, 294, DateTimeKind.Local).AddTicks(2902),
                        ...
                        new
                        {
                            Id = 4,
                            BasePrice = 5000000m,
                            CreatedAt = new DateTime(2025, 6, 26, 16, 39, 19, 294, DateTimeKind.Local).AddTicks(2904),
            ...
            modelBuilder.Entity("SWP391_ITMMS_Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "System",
                            CreatedAt = new DateTime(2025, 6, 26, 16, 39, 19, 21, DateTimeKind.Local).AddTicks(3095),
                            Email = "admin@itmms.com",
                            FullName = "System Administrator",
                            IsActive = true,
                            Password = "$2a$11$Lc9N67wxc/UGhnXDUPKfLOYJKcQzpQmgwi6Z5320twuH0S.D5cNhG",
                            Phone = "0123456789",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            Address = "Hà Nội",
                            CreatedAt = new DateTime(2025, 6, 26, 16, 39, 19, 157, DateTimeKind.Local).AddTicks(5148),
                            Email = "doctor1@itmms.com",
                            FullName = "Dr. Nguyễn Văn A",
                            IsActive = true,
                            Password = "$2a$11$3bfxWeMutoGVhSU93GJLPeTkto7rKhxkyNqJRAtJWvvkIiz9XhT/S",
                            Phone = "0987654321",
                            Role = "Doctor",
                            Username = "doctor1"
                        },
                        new
                        {
                            Id = 4,
                            Address = "Hà Nội",
                            CreatedAt = new DateTime(2025, 6, 26, 16, 39, 19, 294, DateTimeKind.Local).AddTicks(1751),
                            Email = "manager@itmms.com",
                            FullName = "Nguyễn Thị B",
                            IsActive = true,
                            Password = "$2a$11$n.KesFq1LrW2EYX0aAYK1elhcvXLLXYPc3f0hd/50fnEKN1Y8wM8.",
                            Phone = "0123456790",
                            Role = "Manager",
                            Username = "manager1"
                        });
            ...
            modelBuilder.Entity("SWP391_ITMMS_Api.Models.Feedback", b =>
                {
                    b.HasOne("SWP391_ITMMS_Api.Models.Appointment", "Appointment")
                        .WithOne("Feedback")
                        .HasForeignKey("SWP391_ITMMS_Api.Models.Feedback", "AppointmentId")
                        .OnDelete(DeleteBehavior.SetNull);
